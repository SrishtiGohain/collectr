...
<div class="col-12 col-sm-4 col-xl-3 px-sm-2 px-0 d-flex sticky-top bigbox" >
            <div class="d-flex flex-sm-column flex-row flex-grow-1 align-items-center align-items-sm-start px-3 pt-2 text-dark" style="background-color: white;">
                ...
                <ul class="nav nav-pills flex-sm-column flex-row flex-nowrap flex-shrink-1 flex-sm-grow-0 flex-grow-1 mb-sm-auto mb-0 mt-0 mt-md-3 justify-content-center align-items-center align-items-sm-start" id="menu">
                    ...
                    <!-- <li class="nav-item py-2 navBTN">
                        <a href="rest_additem.php" class="nav-link px-sm-0 px-2">
                            <img src="images/plus-square-fill.svg" width="20" height="20"><span class="ms-3 d-none d-sm-inline">Add Item</span>
                        </a>
                    </li>
                    <li><br></li>
                    <li class="nav-item py-2 navBTN">
                        <a href="rest_viewhist.php" class="nav-link px-sm-0 px-2">
                            <img src="images/clock-history.svg" width="20" height="20"><span class="ms-3 d-none d-sm-inline">View History</span> </a>
                    </li>
                    <li><br></li>
                    <li class="nav-item py-2 navBTN">
                        <a href="rest_modifydetails.php" class="nav-link px-sm-0 px-2">
                            <img src="images/pencil-square.svg" width="20" height="20"><span class="ms-3 d-none d-sm-inline">Modify Details</span></a>
                    </li> -->

                    <li><br></li>
                    <li class="nav-item py-2 ">
                    <button class="btn btn-hero bigbox" id="btn" onclick="window.location.href = 'rest_additem.php';">
                    ADD ITEM</button>
                    </li>
                    <li><br></li>
                    <li class="nav-item py-2 ">
                    <button class="btn btn-hero bigbox" id="btn" onclick="window.location.href = 'rest_viewhist.php';">
                   View history</button>
                    </li>
                    <li><br></li>
                    <li class="nav-item py-2 ">
                    <button class="btn btn-hero bigbox" id="btn" onclick="window.location.href = 'rest_request.php';">
                   Organize & Collaborate</button>
                    </li>
                    <li><br></li>
                    <li class="nav-item py-2 ">
                    <button class="btn btn-hero bigbox" id="btn" onclick="window.location.href = 'rest_viewmsg.php';">
                   View Messages</button>
                    </li>
                    <li><br></li>
                    <li class="nav-item py-2 ">
                    <button class="btn btn-hero bigbox" id="btn" onclick="window.location.href = 'rest_modifydetails.php';">
                ...
                <div class="dropdown py-sm-4 mt-sm-auto ms-auto ms-sm-0 flex-shrink-1">
                    <a href="#" class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <span class="d-none d-sm-inline mx-1">User (Hostel Mess)</span>
                    </a>
