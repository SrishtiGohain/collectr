...
<body style="background-color: #d6e3f0;font-family: 'Noto Sans', sans-serif;">
    ...
    <div class="card mx-auto my-sm-4" style="width: 45vw;">
        <img class="card-img-top" src="images/regbg.png" alt="Card image cap">
        <div class="card-body">
            <center>
            <form method="POST" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
                <label for="hash"><strong>Enter your password hash:</strong></label><br>
                <input name="hash" type="text"><br><br>
                <label for="pass"><strong>Enter your new password:</strong></label><br>
                <input name="pass" type="password"><br><br>
                <label for="cpass"><strong>Confirm your new password:</strong></label><br>
                <input name="cpass" type="password"><br><br>
                <button class="btn btn-secondary bigbox" type="submit" name="submit">CHANGE PASSWORD & LOGIN</button><br><br>
            </form>
            </center>   
        </div>
    </div>
