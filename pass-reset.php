...
<body style="background-color: #d6e3f0;font-family: 'Noto Sans', sans-serif;">
    ...
    <div class="card mx-auto my-sm-4 bigbox" style="width: 45vw;">
        <img class="card-img-top" src="images/reg3.jpg" alt="Card image cap">
        <div class="card-body">
            <center><h4 class="card-title fontfix"><b>Enter your registered email id:</b></h4>
            <form method="POST" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
                <input class="reg-input" style="outline:none;" type="email" id="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Ex: name@example.com" required><br><br>
                <label for="user-type" class="fontfix"><strong>User Type:</strong></label><br>
                <select class="reg-input" id="usrtype" name="user-type" required>
                    <option value="Restaurant" class="fontfix">Hostel Mess</option>
                    <option value="NGO" class="fontfix">NGO</option>
                </select><br><br>
                <button class="btn btn-secondary bigbox fontfix" type="submit" name="submail">SEND EMAIL</button><br><br>
            </form>
            </center>   
        </div>
    </div>
