...
?>
    ...
    <div class="container-fluid overflow-hidden">
        <div class="row vh-100 overflow-auto">
            ...
            <div class="col d-flex flex-column h-100" style="background-color:#d6e3f0; ">
                <main class="row">
                    ...
                    <div class="row welc">
                        ...
                        <center>
                            <h3 class="fontfix">Modify Details:</h3> <br>
                            <div class="table-responsive bigbox" style="background-color: white; width:60%; border-radius:8px;">
                                <table>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-secondary bigbox" onclick="edit()">Edit</button>
                                        </td>
                                    </tr>
                                    <tr id="up-addr">
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-secondary bigbox" onclick="edit_email()">Edit</button>
                                        </td>
                                    </tr>
                                    <tr id="up-email">
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-secondary bigbox" onclick="edit_ph()">Edit</button>
                                        </td>
                                    </tr>
                                    <tr id="up-ph">
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-secondary bigbox" onclick="edit_ph2()">Edit</button>
                                        </td>
                                    </tr>
                                    <tr id="up-ph2">
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input class="bigbox" style="margin-bottom:0.5rem; border:none;" placeholder="  Enter current password.." type="password" name="oldpass" required ><br>
                                            <input class="bigbox" style="margin-bottom:0.5rem; border:none;" placeholder="  Enter new password.." type="password" name="pass" required ><br>
                                            <input class="bigbox" style="margin-bottom:0.5rem; border:none;" placeholder="  Confirm new password.." type="password" name="cpass" required ><br>
                                            <button class="btn btn-secondary bigbox" type="submit" name="subpass">Update</button></form>
                                        </td>
                                    </tr>
                                </table>
                            </div>
