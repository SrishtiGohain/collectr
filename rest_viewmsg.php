            ...
            <div class="col d-flex flex-column h-100" style="color: #dae5ed; background-color:#d6e3f0;">
                <main class="row">
                    ...
                    <?php
                        ...
                        $messname=$_SESSION['rusername'];
                        $query = "SELECT * FROM messages WHERE toF = '$messname'";
                        ...
                        <div class="row mx-auto bigbox" style="width:80%;margin-top:20px;background-color:white;">
                            <div class="col-8" style="padding: 2em;">
                                <u>EVENT TYPE : <?php echo $row['eventtype'];?></u><br>NGO NAME :
                                <?php
                                echo $row['fromF'];
                                ?>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <span><b>MESSAGE DESCRIPTION: </b><?php echo $row['eventdesc'];?></span><br>
                                        
                                    </div>
                                    
                                </div>
                                <br><br><br><br><br><br><br>
                                <button class="btn btn-hero bigbox" id="btn" onclick="window.location.href = 'rest_msg.php';">
                    Reply</button>
                            </div>
